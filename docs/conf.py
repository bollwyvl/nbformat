...
latex_documents = [
  (master_doc, 'nbformat.tex', 'nbformat Documentation',
...
man_pages = [
    (master_doc, 'nbformat', 'nbformat Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'nbformat', 'nbformat Documentation',
   author, 'nbformat', 'One line description of project.',
   'Miscellaneous'),
]
